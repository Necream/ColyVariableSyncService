...
string CommandExecutor(string command){
    ...
    if(operation_id==1){ // set
        return "You can't set memory directly, use specific commands like set process or set var.";
    }
    if(operation_id==2){ // get
        return "You can't get memory directly, use specific commands like get process or get var.";
    }
    if(operation_id==3){ // del
        return "You can't delete memory directly, use specific commands like del process or del var.";
    }
    if(operation_id==4){ // sync
        return "You can't sync memory directly, use specific commands like sync process or sync var.";
    }
